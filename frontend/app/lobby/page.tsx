    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-6 gap-2 md:gap-4">
            ...
            <>
              ...
              {hasMore && (
                <div ref={loaderRef} className="mt-6">
                  {loadingMore && (
                    <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-6 gap-3 md:gap-4">
