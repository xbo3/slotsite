...
const adminMenu = [
  ...
  { href: '/admin/coupons', label: '쿠폰관리', icon: CouponIcon },
...
function DashboardIcon({ active }: { active: boolean }) {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke={active ? '#8B5CF6' : '#557086'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
